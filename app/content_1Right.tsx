  ...
  function detailsView() {
    ...
    gridChildren.forEach((element) => {
      element?.addEventListener("click", (e) => {
        ...
        const rightIconGrid = document.querySelector(
          ".rightIconGrid",
        ) as HTMLElement;
        rightIconGrid
          ? ((rightIconGrid.style.padding = "0px"),
            (rightIconGrid.style.margin = "0 auto"))
          : null;
        ...
        if (viewIndex) {
          const elementNameChildren = document.querySelector(
            `.${elementName[0]}-detailsChildren`,
          );
  ...
  function detailsNone() {
    ...
    firstNone.forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        const right = document.querySelector(".right") as HTMLElement;
        rightIconGrid
          ? ((rightIconGrid.style.padding = "10px 10px 10px 10px"),
            (rightIconGrid.style.marginBottom = "70px"))
          : null;
