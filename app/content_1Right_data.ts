const items = [
	...
	},
	{
		...
		text: [
			...
			'JavaScriptの基本的なことは全般的にできます。',
			'ライブラリで提供されているようなアニメーションを伴った',
			'DOM操作も可能です。',
			'フォーム操作やバリデーションも行えます。',
			'Canvasは現在勉強中で、p5.jsを使った2Dゲームの作成経験がありますが',
			'背景で使われるような幾何学模様をイメージ通りに実現することは、',
			'まだ難しいです。',
			'WEBGLはできません。',
			'ReactやNEXT.jsは、基本的な部分は理解しています。',
		]
	},
	{
		name: 'ts',
	...
	},
	{
		...
		text: ['PHPは2024から勉強を始めました。', 'LAMP環境で認証機能とCRUD操作を用いたTODOアプリを作れる程度です。','MVCアーキテクチャは理解してます。','フレームワークはLaravelを勉強してます。']
	},
	{
		name: 'linux',
		title: 'Linux',
